...
@router.get(
    "/tracks/{track_id}/criteria/candidates", response_model=CandidateListResponse
)
...
@router.post(
    "/tracks/{track_id}/criteria/approve",
    response_model=ApproveCriteriaResponse,
)
...
@router.post(
    "/projects/{track_id}/evaluations",
    response_model=ScoreSaveResponse,
)
async def evaluate_projects(track_id: int, request: SaveScoresRequest):
    return InstructorService.evaluate_projects(track_id, request)


@router.get(
    "/tracks/{track_id}/evaluations",
    response_model=EvaluationMatrixResponse,
)
async def get_evaluation_matrix(track_id: int):
    return InstructorService.get_evaluation_matrix(track_id)
